...
![img](https://pic4.zhimg.com/80/v2-7028c83d0320d4f761191e79a133f0e7_720w.jpg)
...
TransformComponent模块的入口在"[http://static_transform_component.cc](https://link.zhihu.com/?target=http%3A//static_transform_component.cc)"和"static_transform_component.h"中。实现了"StaticTransformComponent"类，我们接下来看下它的实现。
...
![img](https://pic4.zhimg.com/80/v2-d595f274ac74c5c1afe8ca8c65a3e043_720w.jpg)

## transform_broadcaster（广播）

我们再来看下transform_broadcaster（广播消息），transform_broadcaster只是做为一个lib库提供给其他模块，入口在"transform_broadcaster.h"和"[http://transform_broadcaster.cc](https://link.zhihu.com/?target=http%3A//transform_broadcaster.cc)"中。
